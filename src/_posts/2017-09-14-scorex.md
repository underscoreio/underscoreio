fter slowly gaining visibility for the past few years, in 2017 cryptocurrencies and 'the blockchain' in general have suddenly gone from something 'you may want to keep an eye on' to something that we ignore at our peril, such is their claimed disruptive potential. Or maybe not - but the interest is certainly skyrocketing.
